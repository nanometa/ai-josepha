...
export default function DiscoverPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "You can find her at 0x08ce97aFcd8e37E486389Cc25ef0f65f59F55a5d. You can verify the code and every single transaction on the Genlayer Studio Network (Chain ID: 61999)."
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="glass-panel p-8 sm:p-10 space-y-8 sticky top-32">
              <div className="space-y-3">
                ...
                <a 
                  href="https://explorer-studio.genlayer.com/address/0x08ce97aFcd8e37E486389Cc25ef0f65f59F55a5d" 
                  target="_blank" 
                ...
                >
                  ...
                  <code className="font-mono text-sm hidden sm:block">
                    0x08ce97aFcd8e37E486389Cc25ef0f65f59F55a5d
                  </code>
