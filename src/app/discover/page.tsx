...
export default function DiscoverPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "You can find her at 0x6D867b5aebe20f54254F6fcC7d7C3c63DDE98249. You can verify the code and every single transaction on the Genlayer Studio Network (Chain ID: 61999)."
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="glass-panel p-8 sm:p-10 space-y-8 sticky top-32">
              <div className="space-y-3">
                ...
                <a 
                  href="https://explorer-studio.genlayer.com/address/0x6D867b5aebe20f54254F6fcC7d7C3c63DDE98249" 
                  target="_blank" 
                ...
                >
                  ...
                  <code className="font-mono text-sm hidden sm:block">
                    0x6D867b5aebe20f54254F6fcC7d7C3c63DDE98249
                  </code>
